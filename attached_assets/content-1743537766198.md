...
- [403 - Forbidden](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/403): You are authenticated, but do not have permission to access the resource.
...
[Try it out](https://wakatime.com/api/v1/stats/2024)
...
A user's coding activity for the given time range as an array of summaries segmented by day. Summaries are read-only representations of [Heartbeats](https://wakatime.com/developers#heartbeats) and [Durations](https://wakatime.com/developers#durations), created by joining multiple Heartbeats together when they’re within 15 minutes of each other. The 15 minutes default can be changed with your account’s Keystroke Timeout preference.
...
[read\_stats.editors](https://wakatime.com/developers#scopes)
...
[email](https://wakatime.com/developers#scopes)
